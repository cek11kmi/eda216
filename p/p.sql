...
VALUES ('Flour',5000000000,'g'),
	('Butter',5000000000,'g'),
	('Icing sugar',5000000000,'g'),
	('Roasted, chopped nuts',5000000000,'g'),
	('Fine-ground nuts',5000000000,'g'),
	('Ground, roasted nuts',5000000000,'g'),
	('Bread crumbs',5000000000,'g'),
	('Sugar',500000000,'g'),
	('Egg whites',5000000000,'dl'),
	('Chocolate',5000000000,'g'),
	('Marzipan',50000000000,'g'),
	('Eggs',500000000,'g'),
	('Potato starch',50000000000,'g'),
	('Wheat flour',5000000000,'g'),
	('Sodium bicarbonate',50000000000,'g'),
	('Vanilla',50000000000,'g'),
	('Chopped almonds',50000000000,'g'),
	('Cinnamon',500000000000,'g'),
	('Vanilla sugar',50000000000,'g');
